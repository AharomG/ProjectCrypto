...
public class ErrorNoHayUsuarios {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("ERROR, no hay usuarios registrados");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel.setBounds(21, 58, 261, 65);
		...
		btnAceptar.setBounds(84, 134, 108, 37);
